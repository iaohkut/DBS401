        ...
        if (isset($_GET['CategoryId'])) {
          if (mysqli_num_rows($Recordset1) > 0) {
            do {
              ...
              <tr>
                <td>
                  <?php echo $row_Recordset1['ItemId']; ?>
                </td>
                <td>
          ...
          if (mysqli_num_rows($Recordset2) > 0) {
            do {
              ...
              <tr>
                ...
                <td>
                  <?php echo htmlspecialchars($row_Recordset2['Description']); ?>
                </td>
                <td>
