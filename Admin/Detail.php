...
$query_Recordset1 = sprintf("SELECT CustomerName, Address, City, Email, Mobile, Gender FROM Customer_Registration WHERE CustomerId = $colname_Recordset1");
      ...
      <table width="100%" border="0">
        ...
        <?php do { ?>
          <tr>
            ...
            <td bgcolor="#BDE0A8">
              <?php echo $row_Recordset1['CustomerName']; ?>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td bgcolor="#E3F2DB">
              <?php echo $row_Recordset1['Gender']; ?>
            </td>
          </tr>
