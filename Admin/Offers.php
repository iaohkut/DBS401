								...
								<table width="100%" height="181" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td><span id="sprytextarea1">
												<label>
													<textarea name="txtDetail" id="txtDetail" cols="45"
														rows="3"></textarea>
												</label>
							...
							<table width="100%" border="1" bordercolor="#003300">
								<tr>
									...
									<th bgcolor="#BDE0A8" class="style3">
										<div align="left" class="style9 style5"><strong>Offer</strong></div>
									</th>
									<th bgcolor="#BDE0A8" class="style3">
										<div align="left" class="style9 style5"><strong>Detail</strong></div>
									</th>
									<th bgcolor="#BDE0A8" class="style3">
										<div align="left" class="style9 style5"><strong>Valid Upto</strong></div>
									</th>
									<th bgcolor="#BDE0A8" class="style3">
									...
									<tr>
										...
										<td class="style3">
											<div align="left" class="style9 style5"><strong><a
														href="DeleteOffer.php?OfferId=<?php echo $Id; ?>">Delete</a></strong>
											</div>
										</td>
									</tr>
									<?php
